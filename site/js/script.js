  ...
  if (plugins.bootstrapTooltip.length) {
    ...
    $(window).on('resize orientationchange', function () {
      if (window.innerWidth < 599) {
        ...
        plugins.bootstrapTooltip.attr('data-placement', 'bottom');
  ...
  if (plugins.slick.length) {
    ...
    for (i = 0; i < plugins.slick.length; i++) {
      ...
      $slickItem.slick({
        ...
        dots: $slickItem.attr("data-dots") || false,
        infinite: $slickItem.attr("data-loop") || false,
        focusOnSelect: true,
        arrows: $slickItem.attr("data-arrows") || false,
  ...
  if (plugins.owl.length) {
    ...
    for (i = 0; i < plugins.owl.length; i++) {
      ...
      c.owlCarousel({
        ...
        autoHeight: c.attr("data-auto-height") !== "false",
        navText: []
      });
    }
  }
